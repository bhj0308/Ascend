...
def upgrade() -> None:
    ...
    sa.Column('user_type', sa.Enum('FOUNDER', 'ENGINEER', 'IEC_WORKER', 'IMMIGRANT', 'ADMIN', name='usertype'), nullable=False),
    ...
    sa.Column('status', sa.Enum('DRAFT', 'OPEN', 'CLOSED', 'FILLED', name='jobstatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('REQUESTED', 'ACTIVE', 'COMPLETED', 'DECLINED', name='mentorshipstatus'), nullable=False),
    ...
    sa.Column('payment_type', sa.Enum('SALARY', 'CONTRACT_PAYMENT', 'REMITTANCE', name='paymenttype'), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'PROCESSING', 'COMPLETE', 'FAILED', 'CANCELLED', name='paymentstatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('APPLIED', 'REVIEWING', 'INTERVIEWING', 'OFFERED', 'REJECTED', 'HIRED', 'WITHDRAWN', name='applicationstatus'), nullable=False),
    ...
    sa.Column('template_type', sa.Enum('KOREA_ENGINEER_CANADA_CO', 'CANADA_ENGINEER_KOREA_CO', 'REMOTE_CONTRACTOR', 'FULL_TIME_DOMESTIC', 'PART_TIME_GIG', name='contracttemplatetype'), nullable=False),
    sa.Column('status', sa.Enum('DRAFT', 'PENDING_SIGNATURE', 'SIGNED', 'CANCELLED', name='contractstatus'), nullable=False),
